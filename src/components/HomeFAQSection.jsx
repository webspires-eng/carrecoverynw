    ...
    const faqs = [
        {
            ...
            a: "We typically arrive within 15 to 30 minutes depending on your location. Our nationwide network ensures the local driver nearest to you is sent immediately."
        },
        {
            q: "Do you cover motorway recovery?",
            a: "Yes, we specialize in emergency motorway recovery on all major UK motorways (M1, M6, M25, M5, etc). We prioritize motorway call-outs due to safety risks."
        },
        {
        ...
        },
        {
            ...
            a: "Yes, we can recover your vehicle to any destination of your choice, whether it's your home address, a preferred local garage, or a dealership anywhere in the UK."
        },
        {
        ...
        },
        {
            ...
            a: "We provide nationwide recovery services across the entire United Kingdom. From local breakdown assistance to long-distance transport, we have you covered."
        },
        {
        ...
        },
        {
            ...
            a: "Costs depend on distance and complexity. We provide a firm quote before we dispatch, so you know exactly what you'll pay with no hidden fees."
        }
    ];
