...
export default function HomeHeroSection({ location = "United Kingdom" }) {
        ...
        <>
            ...
            <section className="layout1">
                <div className="title-info">
                    <h4>24 Hours</h4>
                    {/* Removed "& Outskirts" for Home Page version */}
                    <h1>Car Recovery Service In <span className="location-name">{location}</span></h1>
