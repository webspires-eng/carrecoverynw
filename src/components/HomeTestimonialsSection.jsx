...
export default function HomeTestimonialsSection() {
    const testimonials = [
        ...
        },
        {
            ...
            name: "David Miller",
            rating: 5,
            // Replaced generic location with "the UK" for Home Page context
            text: "Top notch recovery service. Transparent about the cost from the start and no hidden fees. Definitely the best in the UK."
        }
    ];
