            ...
            <div className="admin-main">
                ...
                <header className="cms-topbar">
                    <div className="cms-topbar-left">
                        <Link prefetch={false} href="/admin/areas" className="cms-back-link">
                        ...
                        <span className="cms-topbar-current">Edit: {formData.name}</span>
                    </div>
                    <div className="cms-topbar-right">
                        {saveStatus === 'success' && (
                            <span className="cms-save-toast">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                        ...
                        <Link prefetch={false} href={`/areas/${formData.slug}`} target="_blank" className="btn btn-secondary cms-topbar-btn">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <button type="submit" form="area-form" className="btn btn-primary cms-topbar-btn" disabled={saving}>
                            {saving ? (
                    ...
                    <div className="cms-title-section">
                        ...
                        <div className="cms-permalink">
                            ...
                            <input
                                ...
                                required
                            />
                            <Link prefetch={false} href={`/areas/${formData.slug}`} target="_blank" className="cms-permalink-view">
                        ...
                        <div className="cms-sidebar">
                            ...
                            <div className="cms-sidebar-box cms-publish-box">
                                ...
                                <div className="cms-sidebar-box-body">
                                    <div className="cms-publish-info">
                                        <div className="cms-publish-row">
                                            ...
                                            <span className="cms-status-badge cms-status-published">Published</span>
                                        </div>
                                        <div className="cms-publish-row">
                                            <span className="cms-publish-label">URL:</span>
                                            <Link prefetch={false} href={`/areas/${formData.slug}`} target="_blank" className="cms-publish-value cms-publish-url">
                                                /areas/{formData.slug || '...'}
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="cms-sidebar-box-footer">
                                    <button type="submit" className="btn btn-primary cms-publish-btn" disabled={saving}>
                                        {saving ? (
                                            <><div className="btn-spinner"></div>Updating...</>
                                        ) : saveStatus === 'success' ? (
                                            <>
                            ...
                            <div className="cms-sidebar-box">
                                ...
                                <div className="cms-sidebar-box-body">
                                    <RebuildAreaLinksButton
                                        ...
                                        disabledHint="Save the area first to rebuild its links."
                                    />
                                    {(() => {
